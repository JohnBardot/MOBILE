 ...
 TextLabel_1.Text = "Key System - MOBILE" 
 ...
 CheckKey_1.MouseButton1Click:Connect(function()   
    ...
    loadstring(game:HttpGet("https://raw.githubusercontent.com/JohnBardot/MOBILE/main/LegendsOfSpeedMobile.txt"))()               
            game.CoreGui:FindFirstChild("KeySystem"):Destroy()   
              elseif game.PlaceId == 3623096087 then -- Muscle Legends 
              loadstring(game:HttpGet("https://raw.githubusercontent.com/JohnBardot/MOBILE/main/MuscleLegendsMobile.txt"))()
              game.CoreGui:FindFirstChild("KeySystem"):Destroy()   
 elseif game.PlaceId == 5490351219 then -- Clicker Madness
 loadstring(game:HttpGet("https://raw.githubusercontent.com/JohnBardot/MOBILE/main/ClickerMadnessMobile.txt"))()
              game.CoreGui:FindFirstChild("KeySystem"):Destroy()   
  else  
